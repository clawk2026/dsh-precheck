 ...
 */
export const DEFAULT_FC_QUERY_URL = "https://zhuangqha-query-bvbvcmwrdb.cn-hangzhou.fcapp.run";
/**
 ...
 */
export const RETRY_HINT = "Results usually appear within a few hours (next scheduled pipeline run, up to about 3 hours). This is not instant.";
